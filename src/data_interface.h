...
template<typename ArrayType, typename ElementType, typename IndexType = size_t>
void set_at(ArrayType &candidates, const ElementType &value, const IndexType iCandidate);
...
template<>
void set_at(vector<CandidateString> &candidates, const CandidateString &value, const size_t iCandidate) {
